...
public partial class TSOpenSessionReq : TBase
{
  ...
  {
    var tmp50 = new TSOpenSessionReq();
    tmp50.Client_protocol = this.Client_protocol;
    if((ZoneId != null))
    {
      tmp50.ZoneId = this.ZoneId;
    }
    if((Username != null) && __isset.username)
    {
      tmp50.Username = this.Username;
    }
    tmp50.__isset.username = this.__isset.username;
    if((Password != null) && __isset.password)
    {
      tmp50.Password = this.Password;
    }
    tmp50.__isset.password = this.__isset.password;
    if((Configuration != null) && __isset.configuration)
    {
      tmp50.Configuration = this.Configuration.DeepCopy();
    }
    tmp50.__isset.configuration = this.__isset.configuration;
    return tmp50;
  }
            ...
            {
              {
                ...
                Configuration = new Dictionary<string, string>(_map51.Count);
                for(int _i52 = 0; _i52 < _map51.Count; ++_i52)
                {
                  string _key53;
                  string _val54;
                  _key53 = await iprot.ReadStringAsync(cancellationToken);
                  _val54 = await iprot.ReadStringAsync(cancellationToken);
                  Configuration[_key53] = _val54;
                }
    ...
    try
    {
      ...
      if((Configuration != null) && __isset.configuration)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter55 in Configuration.Keys)
          {
            await oprot.WriteStringAsync(_iter55, cancellationToken);
            await oprot.WriteStringAsync(Configuration[_iter55], cancellationToken);
          }
