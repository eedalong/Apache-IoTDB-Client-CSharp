...
public partial class TSFetchResultsResp : TBase
{
  ...
  public TSFetchResultsResp DeepCopy()
  {
    ...
    if((Status != null))
    {
      tmp75.Status = (TSStatus)this.Status.DeepCopy();
    }
    tmp75.HasResultSet = this.HasResultSet;
    tmp75.IsAlign = this.IsAlign;
    if((QueryDataSet != null) && __isset.queryDataSet)
    {
      tmp75.QueryDataSet = (TSQueryDataSet)this.QueryDataSet.DeepCopy();
    }
    tmp75.__isset.queryDataSet = this.__isset.queryDataSet;
    if((NonAlignQueryDataSet != null) && __isset.nonAlignQueryDataSet)
    {
      tmp75.NonAlignQueryDataSet = (TSQueryNonAlignDataSet)this.NonAlignQueryDataSet.DeepCopy();
    }
    tmp75.__isset.nonAlignQueryDataSet = this.__isset.nonAlignQueryDataSet;
    return tmp75;
  }
