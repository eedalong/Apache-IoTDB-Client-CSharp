...
public partial class TSDeleteDataReq : TBase
{
  ...
  {
    var tmp215 = new TSDeleteDataReq();
    tmp215.SessionId = this.SessionId;
    if((Paths != null))
    {
      tmp215.Paths = this.Paths.DeepCopy();
    }
    tmp215.StartTime = this.StartTime;
    tmp215.EndTime = this.EndTime;
    return tmp215;
  }
            ...
            {
              {
                ...
                Paths = new List<string>(_list216.Count);
    ...
    try
    {
      ...
      if((Paths != null))
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter219 in Paths)
          {
