...
public partial class TSCreateTimeseriesReq : TBase
{
  ...
  {
    var tmp221 = new TSCreateTimeseriesReq();
    tmp221.SessionId = this.SessionId;
    if((Path != null))
    {
      tmp221.Path = this.Path;
    }
    tmp221.DataType = this.DataType;
    tmp221.Encoding = this.Encoding;
    tmp221.Compressor = this.Compressor;
    if((Props != null) && __isset.props)
    {
      tmp221.Props = this.Props.DeepCopy();
    }
    tmp221.__isset.props = this.__isset.props;
    if((Tags != null) && __isset.tags)
    {
      tmp221.Tags = this.Tags.DeepCopy();
    }
    tmp221.__isset.tags = this.__isset.tags;
    if((Attributes != null) && __isset.attributes)
    {
      tmp221.Attributes = this.Attributes.DeepCopy();
    }
    tmp221.__isset.attributes = this.__isset.attributes;
    if((MeasurementAlias != null) && __isset.measurementAlias)
    {
      tmp221.MeasurementAlias = this.MeasurementAlias;
    }
    tmp221.__isset.measurementAlias = this.__isset.measurementAlias;
    return tmp221;
  }
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
            ...
            {
              {
                ...
                Props = new Dictionary<string, string>(_map222.Count);
                for(int _i223 = 0; _i223 < _map222.Count; ++_i223)
                {
                  string _key224;
                  string _val225;
                  _key224 = await iprot.ReadStringAsync(cancellationToken);
                  _val225 = await iprot.ReadStringAsync(cancellationToken);
                  Props[_key224] = _val225;
                }
          ...
          case 7:
            ...
            {
              {
                TMap _map226 = await iprot.ReadMapBeginAsync(cancellationToken);
                Tags = new Dictionary<string, string>(_map226.Count);
                for(int _i227 = 0; _i227 < _map226.Count; ++_i227)
                {
                  string _key228;
                  string _val229;
                  _key228 = await iprot.ReadStringAsync(cancellationToken);
                  _val229 = await iprot.ReadStringAsync(cancellationToken);
                  Tags[_key228] = _val229;
                }
                await iprot.ReadMapEndAsync(cancellationToken);
              }
            }
          ...
          case 8:
            ...
            {
              {
                TMap _map230 = await iprot.ReadMapBeginAsync(cancellationToken);
                Attributes = new Dictionary<string, string>(_map230.Count);
                for(int _i231 = 0; _i231 < _map230.Count; ++_i231)
                {
                  string _key232;
                  string _val233;
                  _key232 = await iprot.ReadStringAsync(cancellationToken);
                  _val233 = await iprot.ReadStringAsync(cancellationToken);
                  Attributes[_key232] = _val233;
                }
                await iprot.ReadMapEndAsync(cancellationToken);
              }
            }
    ...
    try
    {
      ...
      if((Props != null) && __isset.props)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter234 in Props.Keys)
          {
            await oprot.WriteStringAsync(_iter234, cancellationToken);
            await oprot.WriteStringAsync(Props[_iter234], cancellationToken);
          }
      ...
      if((Tags != null) && __isset.tags)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter235 in Tags.Keys)
          {
            await oprot.WriteStringAsync(_iter235, cancellationToken);
            await oprot.WriteStringAsync(Tags[_iter235], cancellationToken);
          }
          await oprot.WriteMapEndAsync(cancellationToken);
        }
        await oprot.WriteFieldEndAsync(cancellationToken);
      ...
      if((Attributes != null) && __isset.attributes)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter236 in Attributes.Keys)
          {
            await oprot.WriteStringAsync(_iter236, cancellationToken);
            await oprot.WriteStringAsync(Attributes[_iter236], cancellationToken);
          }
          await oprot.WriteMapEndAsync(cancellationToken);
        }
        await oprot.WriteFieldEndAsync(cancellationToken);
