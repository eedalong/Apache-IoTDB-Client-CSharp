...
public partial class TSCloseOperationReq : TBase
{
  ...
  {
    var tmp71 = new TSCloseOperationReq();
    tmp71.SessionId = this.SessionId;
    if(__isset.queryId)
    {
      tmp71.QueryId = this.QueryId;
    }
    tmp71.__isset.queryId = this.__isset.queryId;
    if(__isset.statementId)
    {
      tmp71.StatementId = this.StatementId;
    }
    tmp71.__isset.statementId = this.__isset.statementId;
    return tmp71;
  }
