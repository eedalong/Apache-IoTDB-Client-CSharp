...
public partial class TSInsertStringRecordReq : TBase
{
  ...
  {
    var tmp95 = new TSInsertStringRecordReq();
    tmp95.SessionId = this.SessionId;
    if((DeviceId != null))
    {
      tmp95.DeviceId = this.DeviceId;
    }
    if((Measurements != null))
    {
      tmp95.Measurements = this.Measurements.DeepCopy();
    }
    if((Values != null))
    {
      tmp95.Values = this.Values.DeepCopy();
    }
    tmp95.Timestamp = this.Timestamp;
    return tmp95;
  }
            ...
            {
              {
                ...
                Values = new List<string>(_list99.Count);
    ...
    try
    {
      ...
      if((Measurements != null))
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter102 in Measurements)
          {
      ...
      if((Values != null))
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter103 in Values)
          {
