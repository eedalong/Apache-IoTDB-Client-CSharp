...
public partial class TSInsertRecordReq : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("TSInsertRecordReq");
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (string _iter54 in Measurements)
        {
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("TSInsertRecordReq(");
